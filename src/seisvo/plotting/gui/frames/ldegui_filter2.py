...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.treeWidget.topLevelItem(0).setText(0, _translate("Dialog", "i1"))
        self.treeWidget.topLevelItem(0).setText(1, _translate("Dialog", "i2"))
        self.treeWidget.topLevelItem(1).setText(0, _translate("Dialog", "i3"))
