...
class Network(object):
    ...
    def gui(self, starttime, station_list, component="Z", delta=30, sde_file=None, **kwargs):
        ...
        def lte(self, starttime, endtime, channel_list, window, subwindow, interval=1, channel=None, subwindow_olap=0.75, **kwargs):
            """ Compute LTE file for CSW process, based on Seydoux 2016 work
            ...
            # load parameters
            channel     = self.check_channel(channel_list)
